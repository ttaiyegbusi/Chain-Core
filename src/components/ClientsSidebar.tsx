...
const MENU: MenuItem[] = [
  { label: "Individual", icon: UserCircle2, href: "/clients/individual" },
  { label: "Corporate", icon: Building2, href: "/clients/corporate" },
  { label: "Center", icon: Home, href: "/clients/center" },
